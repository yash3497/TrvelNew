...
class ReportIncorrectUserScreen extends StatefulWidget {
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Checkbox(
                            activeColor: primary,
                            checkColor: black,
                            value: incorrectCheckboxList[i].isSelected,
                            onChanged: (value) {
                              setState(() {
                                for (var element in incorrectCheckboxList) {
                                  element.isSelected = false;
                                }
                                incorrectCheckboxList[i].isSelected = value!;
                              });
                            },
                          ),
                        ),
                        Text(
                          incorrectCheckboxList[i].name,
