...
class ProfileFeedWidget extends StatelessWidget {
  ...
  final List overlap;
  var _future = FirebaseFirestore.instance.collection('profileFeeds');
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: FutureBuilder<DocumentSnapshot>(
          future: _future.doc('FJZ6rRjZvQpCl44JmNMr').get(),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        SizedBox(
                                          ...
                                          child: Text(
                                            'Your trip friend ${_names[i]} has joined a trip which might be of your interest. ',
